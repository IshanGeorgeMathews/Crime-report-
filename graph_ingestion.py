...
from identity_review_queue import IdentityReviewQueue
from non_crime_handler import NonCrimeHandler
        ...
        for idx, text in enumerate(texts):
            ...
            for cand in person_candidates:
                ...
                for pn in parent_names_clean:
                    from utils import is_fuzzy_match as utils_is_fuzzy_match
