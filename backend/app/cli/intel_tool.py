...
# Ensure the project and module directories are on the path
base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
sys.path.insert(0, base_dir)
# Also add backend to path so 'app.infrastructure...' imports work
...
from app.infrastructure.neo4j.graph_db import GraphDatabase, GNNModelManager, _is_valid_person_name
from app.modules.reports.real_report_data import REPORTS_09_03
...
def extract_items_from_docx(fpath: str) -> list:
    ...
    from app.infrastructure.documents.utils import extract_details_from_docx_paragraphs, DISTRICT_CODES
    import re
...
def _sync_profiles_from_texts(texts: list, report_date: str, use_ollama: bool):
    ...
    from app.modules.graph.graph_ingestion import GraphIngestionService
