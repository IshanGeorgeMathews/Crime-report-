...
from utils import load_profile_database, PersonProfile, create_new_profile, save_uo_note, generate_uo_note_text
from app.config import settings
from app.db.models import Profile, ProfileCase, ProfileRelation, ProfileActivity
