...
from app.infrastructure.database.models import Job, JobEvent, Report, ReportItem
...
class ConsolidationService:
    ...
    async def cancel_job(self, job_id: str, source_files_dir: str = None):
        ...
        if date_str:
            try:
                from app.infrastructure.neo4j.graph_db import GraphDatabase
            ...
            for idx, fpath in enumerate(all_files):
                ...
                try:
                    ...
                    if is_alert_file:
                        ...
                        from app.infrastructure.documents.utils import extract_details_from_docx_paragraphs
