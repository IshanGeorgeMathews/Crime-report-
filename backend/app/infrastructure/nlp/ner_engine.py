...
# Import profile creation helper from app.infrastructure.documents.utils
from app.infrastructure.documents.utils import create_new_profile
...
class NEREngine:
    ...
    def extract_person_names(self, text: str) -> list:
        ...
        if not candidates:
            from app.infrastructure.documents.utils import extract_candidate_names_from_text
