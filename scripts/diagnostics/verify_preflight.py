...
# ═══════════════════════════════════════════════════════════
# Determine project root (this file lives in scripts/diagnostics)
# ═══════════════════════════════════════════════════════════
...
# Add root and core to path so we can import utils, intel_tool etc.
if str(ROOT) not in sys.path:
    sys.path.insert(0, str(ROOT))

# Add modules and infrastructure to path for internal imports
app_dir = ROOT / "backend" / "app"
sys.path.insert(0, str(app_dir / "infrastructure" / "neo4j"))
sys.path.insert(0, str(app_dir / "infrastructure" / "nlp"))
sys.path.insert(0, str(app_dir / "infrastructure" / "translation"))
sys.path.insert(0, str(app_dir / "infrastructure" / "documents"))
sys.path.insert(0, str(app_dir / "infrastructure" / "ollama"))
sys.path.insert(0, str(app_dir / "infrastructure" / "qdrant"))
sys.path.insert(0, str(app_dir / "modules" / "graph"))
sys.path.insert(0, str(app_dir / "modules" / "reports"))
sys.path.insert(0, str(app_dir / "modules" / "consolidation"))
sys.path.insert(0, str(app_dir / "cli"))
...
BACKEND_IMPORTS = [
    ...
    "app.api.v1.router",
    "app.modules.consolidation.consolidation_service",
    "app.infrastructure.qdrant.qdrant_service",
    "app.modules.profiles.profile_service",
    "app.modules.graph.graph_service",
    "app.modules.consolidation.ner_service",
    "app.infrastructure.ollama.llm_service",
    "app.infrastructure.translation.translation_service",
]
